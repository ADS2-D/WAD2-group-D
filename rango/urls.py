...
urlpatterns = [
    ...
    url(r'^group/(?P<group_id>[\w\-]+)/leaderboards/$', views.group_leaderboards_index,
        name='group_leaderboards_index'),
    url(r'^group/(?P<group_id>[\w\-]+)/leaderboards/(?P<workout_id>[\w\-]+)/$', views.group_leaderboards_workout,
        name='group_leaderboards_workout'),
